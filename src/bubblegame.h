...
struct Penguin {
    ...
    int PlayAnimation(int animId) {
        ...
        switch(curAnimation) {
            ...
            case 5: curFrame = curFrame < 51 || curFrame > 70 ? (invertAnimation == true ? 70 : 51) : curFrame; break;
            case 6: curFrame = 71; break;
            case 7: curFrame = curFrame < 51 || curFrame > 71 ? (invertAnimation == true ? 71 : 51) : curFrame; break;
            case 8: curFrame = curFrame < 1 || curFrame > 74 ? (invertAnimation == true ? 74 : 1) : curFrame; break;
